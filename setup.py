...
setup(name='quadedge',
    version='0.1',
    ext_modules=[Extension('_quadedge', sources=['edge.cc','list.cc','cell.cc','face.cc','vertex.cc','jacobian.cc','derivative.cc', 'obj.cc','quadedge.i'],
    ...
    headers=['edge.hh','list.hh','cell.hh','face.hh','vertex.hh','jacobian.hh','derivative.hh','obj.hh']
)
